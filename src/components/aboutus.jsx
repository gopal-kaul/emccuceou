  ...
  return (
    <>
      <Container style={{ marginTop: "3%", marginBottom: "3%" }}>
        <h1>
          <strong>Engineers’ Music and Cultural Club - EMC²</strong>
        </h1>
        <hr />
        <br />
        <h3 style={{ fontWeight: "600" }}>Who are we?</h3>
        ...
        <br />
        <h3 style={{ fontWeight: "600" }}>What do we do?</h3>
        <p style={{ fontSize: "1.12rem" }}>
        ...
        <br />
        <h3 style={{ fontWeight: "600" }}>Events participated by EMC²</h3>
        <p style={{ fontSize: "1.12rem" }}>
